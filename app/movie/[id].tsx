      ...
      >
        ...
        <View className="flex-col items-start justify-center mt-5 px-5">
          ...
          >
            ...
            <Text className="text-white font-bold text-xl">{Math.round(movie?.vote_average ?? 0)}/10</Text>
          ...
          <View className="flex flex-row justify-between w-1/2">
            <MovieInfo label="Budget" value={`${(movie?.budget as number) / 1_000_000} milion`}/>
            <MovieInfo label="Revenue" value={`${Math.round(movie?.revenue as number) / 1_000_000} milion`}/>
          </View>
